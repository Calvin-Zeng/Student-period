<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="traindetails.aspx.vb" Inherits="ProjectHsrSystem_Final.traindetails" %>
            ...
            <tr>
                <td>
                    <asp:GridView ID="GridView1" runat="server" HorizontalAlign="Center" 
                        ...
                        <Columns>
                            <asp:BoundField DataField="站名" HeaderText="站名" SortExpression="站名" />
                            <asp:BoundField DataField="開車時間" HeaderText="開車時間" SortExpression="開車時間">
