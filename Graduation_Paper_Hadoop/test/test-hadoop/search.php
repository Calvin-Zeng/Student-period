...
<div id="wrapper"> 
	<div id="page">
		...
		<div id="content">
			<div class="post">
				<h2 class="title"><a href="#">搜尋紀錄</a></h2>
				<div class="addbox">
					<div class="dropdown">
						<select name="one" class="dropdown-select">
							<option >移置…</option>
							<option value="1" >阿禡古老的歌</option>
							<option value="2">不小心錄到</option>
							<option value="3">錄到鬼聲 T_T</option>
						</select>
					</div>
					<div class="dropdown">
				...
				<p class="links" > <input type="checkbox"    class="songcheck" name="song1" value="黃韻玲-美好歲月"/><a href="info.php"> 黃韻玲-美好歲月 </a></input></p>
				</div>
				<div class="songbox"> 
				<a href="#"><img class="songimg" src="images/test.jpg"   /><a><br>
				<p class="links" > <input type="checkbox"    class="songcheck" name="song2" value="黃韻玲-美好歲月"/><a href="info.php"> 黃韻玲-美好歲月 </a></input></p>
				</div>
				<div class="songbox"> 
				<a href="#"><img class="songimg" src="images/test.jpg"   /><a><br>
				<p class="links" > <input type="checkbox"    class="songcheck" name="song3" value="黃韻玲-美好歲月"/><a href="info.php"> 黃韻玲-美好歲月 </a></input></p>
				</div>
				<div class="songbox"> 
				<a href="#"><img class="songimg" src="images/test.jpg"   /><a><br>
				<p class="links" > <input type="checkbox"    class="songcheck" name="song4" value="黃韻玲-美好歲月"/><a href="info.php"> 黃韻玲-美好歲月 </a></input></p>
				</div>
			</div>
		</div>
	</div>
